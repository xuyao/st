...
//	String[] args={"zzf"};
	...
	String[][] year={{"2019-01-01","2020-01-01"},{"2018-01-01","2019-01-01"},{"2017-01-01","2018-01-01"},{"2016-01-01","2017-01-01"},
			{"2015-01-01","2016-01-01"},{"2014-01-01","2015-01-01"}};
...
//	String[][] year={{"2019-01-01","2020-01-01"},{"2018-01-01","2019-01-01"},{"2017-01-01","2018-01-01"}};
	...
	public List<String> guding(){
		...
		for(String arg : args){
			...
			String url = "http://fund.eastmoney.com/data/rankhandler.aspx?op=ph&dt=kf&ft=zq&rs=&gs=0&sc="+arg+"&st=desc&sd="+date+"&ed="+date+
					"&qdii=&tabSubtype=,,,,,&pi=1&pn="+num+"&dx=1&v=0."+NumberUtil.getRandomNum(17);
			try {
				ArrayList<String> listfund = new ArrayList<String>();
				String result = http.sendGet(url, nameValuePairList);
				String all = StrUtils.subString(result, "allRecords:", ",pageIndex");
				Integer top = Integer.parseInt(all)/3;
	...
	public List<String> year(){
		...
		for(String[] ys : year){
			List<NameValuePair> nameValuePairList = new ArrayList<NameValuePair>();
			String url = "http://fund.eastmoney.com/data/rankhandler.aspx?op=ph&dt=kf&ft=zq&rs=&gs=0&sc=qjzf&st=desc&sd="+ys[0]+
